...
@Profile("kmehr")
@Service
class PatientInfoLogicImpl(
    private val patientInfoFileExport: PatientInfoFileExport
) : PatientInfoFileLogic {
    override fun createExport(patient: Patient, sender: HealthcareParty, language: String): Flow<DataBuffer> =
        patientInfoFileExport.export(patient, sender, language)
